...
BEGIN
    ...
    ('Thừa Thiên Huế', central_id, ARRAY['hue', 'tthue', 'thuathienhue', 'thua thien hue', 'thừa thiên huế'], TRUE),
...
('Đầu Đuôi', 
 ...
 ARRAY['2 digits'], 
 'Match the last 2 digits of the draw', 
...
('Xỉu chủ', 
 ...
 ARRAY['south', 'central', 'north'], 
 ARRAY['3 digits'], 
 'Match the last 3 digits of the draw', 
 '650'::jsonb, 
...
('Đầu', 
 ...
 'Match the last 2 or 3 digits of the draw', 
...
('Bao Lô', 
 ...
 'Match the last 2, 3, or 4 digits of the draw', 
...
('Đảo Bao Lô', 
 ...
 ARRAY['south', 'central', 'north'], 
 ARRAY['2 digits', '3 digits'], 
 'Match any permutation of the last N digits of the draw', 
 '{"2 digits": 75, "3 digits": 650}'::jsonb, 
...
('Bao Lô 7', 
 ...
 ARRAY['south', 'central'], 
 ARRAY['2 digits'], 
 'Match the last 2 digits of specific prizes', 
 '75'::jsonb, 
...
('Đá', 
 ...
 ARRAY['south', 'central', 'north'], 
 ARRAY['2 digits'], 
 'At least 2 betted numbers match the draw', 
...
('Đảo Xỉu Chủ', 
 ...
 ARRAY['south', 'central', 'north'], 
 ARRAY['3 digits'], 
 'Match any permutation of the last 3 digits of the draw', 
 '650'::jsonb, 
 '{"south": 2, "central": 2, "north": 4}'::jsonb, 
 TRUE, 
 NULL,
...
('Nhất To', 
 ...
 ARRAY['north'], 
 ARRAY['2 digits', '3 digits', '4 digits'], 
 'Match the last N digits of the first prize', 
 '{"2 digits": 75, "3 digits": 650, "4 digits": 5500}'::jsonb, 
 '{"north": 1}'::jsonb, 
 FALSE, 
 NULL,
